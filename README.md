...
- Sección activa de Fase B: `Sección 1 (D19-D34) con D19 a D29 completados`
...
- `docs/p01/fase_b/d27_d28_reporte.md`: resultados ejecutados de D27 y D28.
- `docs/p01/fase_b/d29_reporte.md`: resultados ejecutados de D29.
...
- `infra/p01/fase_b/metricas_d27_d28.json`: métricas consolidadas de D27-D28.
- `infra/p01/fase_b/metricas_d29.json`: métricas consolidadas de D29.
...
- `scripts/fase_b/ejecutar_d27_d28.sh`: ejecución integrada de D27-D28 (dedup + minimización + repro).
- `scripts/fase_b/validar_d27_d28.py`: validación de cierre para D27-D28.
- `scripts/fase_b/ejecutar_d29.sh`: ejecución integrada de D29 (repro automático + contrato estándar).
- `scripts/fase_b/validar_d29.py`: validación de cierre para D29.
